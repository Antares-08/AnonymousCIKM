...
class FakingRecipe_Dataset(Dataset):
    def __init__(self, vid_path,dataset):
        ...
        if dataset=='fakesv': 
            self.data_all = pd.read_json('',orient='',dtype=False,lines=True)
            self.vid=[]
